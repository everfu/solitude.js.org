...
Navigate repeatedly between the same two pages. Duplicate dialogs, players, callbacks, or network requests usually indicate custom code that registers permanent resources on every `afterNavigate`. Subscribe once, or dispose page-specific work before the next navigation.
