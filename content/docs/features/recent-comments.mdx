...
description: "Display recent comment activity as a standalone page."
---
## Purpose

Display recent comment activity as a standalone page.

## Create the page

Create a page under `source/recentcomments/index.md` and set a clear title.
...
Put repeatable content in `source/_data/recent-comments.yml`.
...
<Files>
  ...
  <File name="source" />
  <File name="_data" />
  <File name="recent-comments.yml" />
  <File name="recentcomments" />
  <File name="index.md" />
</Files>
