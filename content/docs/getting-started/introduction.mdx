...
<Callout type="info">
The examples in these docs target Solitude v4.0.0. When moving from 3.x, follow [Upgrade to 4.0](/docs/getting-started/upgrade-v4) and merge your values into a fresh Solitude 4 configuration.
</Callout>
