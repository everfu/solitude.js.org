...
Edit the root copy. Do not edit package files under `node_modules`. Existing users should merge the new file instead of overwriting their customized configuration; see [Upgrading to 4.0](/docs/getting-started/upgrade-v4).
