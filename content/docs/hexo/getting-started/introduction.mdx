...
Solitude 4 is a Hexo theme for personal blogs. It provides homepage modules, post metadata, sidebars, feature pages, search, comments, PWA support, and a browser API.
...
<Callout type="info">
The examples in these docs target Solitude v4.0.0. When moving from 3.x, follow [Upgrade to 4.0](/docs/hexo/getting-started/upgrade-v4) and merge your values into a fresh Solitude 4 configuration.
</Callout>
