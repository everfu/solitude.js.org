...
No. Start with the complete Solitude 4 default file and merge your customized values into it. This preserves new nested defaults and avoids carrying removed assumptions into 4.0. Follow the full [Upgrade to 4.0](/docs/hexo/getting-started/upgrade-v4) checklist before rebuilding.
