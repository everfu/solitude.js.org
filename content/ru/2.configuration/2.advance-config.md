...
busuanzi: false
# 0: Original / 1: Custom
# 0: Оригинальная версия / 1: Пользовательская версия
busuanzi_use: 0
# --------------------------- end ---------------------------
```
...
google_adsense:
  ...
  auto_ads: false
  # Page-level ads
  # Реклама на уровне страницы
  enable_page_level_ads: true
  # Sidebar card ads
  # Реклама в карточке боковой панели
  aside_card: true
  # Post card ads
  # Реклама в карточке статьи
  post_card: true
  # Post content ads
  # Реклама в содержимом статьи
  post_content: true
  # Google Adsense js
  # Google Реклама js
