...
description: Узнайте, как настроить основные параметры темы Solitude.
icon: lucide:file-cog
---

### Конфигурация сайта

Измените различную информацию о сайте, такую как заголовок, подзаголовок и личную информацию, например, электронную почту.

Рекомендуется сначала настроить информацию, связанную с сайтом, в конфигурации Hexo и темы
...
::tabs{variant="card"}
  ...
  ```yaml
  # Site
  title: 伍拾柒 # Заголовок блога
  subtitle: "" # Подзаголовок
  description: Осторожно стараться и обладать. # Описание блога
  keywords: 伍拾柒 # Ключевые слова блога
  author: 伍拾柒 # Имя автора блога
  language: ru-RU # Язык
  timezone: Europe/Moscow # Часовой пояс (проверьте самостоятельно)
  ```
  ::
  ...
  site:
    ...
    icon: /img/pwa/favicon.png # Site icon / Иконка сайта
  ```
  ::
::
...
::tabs{variant="card"}
  ::div{label="Все" icon="lucide:text"}
...
::alert{type="note" icon="lucide:pencil"}
  Для использования `Статья с локальным ИИ` необходимо прописать `ai_text: содержание аннотации` в `front-matter`
::
...
## Напоминание об истекшей статье
...
## Плавающая панель навигации в правом нижнем углу
...
footer:
  ...
  information:
    author: false # url изображения / false
    left:
      # Github: https://github.com/everfu || fab fa-github # Название: ссылка || иконка
  ...
  # Случайные дружественные ссылки
  randomlink: false # Случайные дружественные ссылки

  # Регистрационная информация
  beian:
    # - name: Свидетельство о полицейской регистрации Сян №43048102000175
    #   icon: https://beian.mps.gov.cn/img/logo01.dd7ff50e.png
    #   url: https://beian.mps.gov.cn/#/query/webSearch
    # - name: Регистрационный номер ICP Сян №2024080357-1
    #   url: https://beian.miit.gov.cn/

  # Текст информации в нижнем колонтитуле
  links:
    # - name: RSS
    #   url: /atom.xml
    # - name: Лицензия
