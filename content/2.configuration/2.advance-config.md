...
You can insert custom website files.
...
Enable the theme's `pwa` configuration and activate `swpp` in the Hexo configuration.
...
Add the swpp configuration at the bottom of the Hexo configuration file.
